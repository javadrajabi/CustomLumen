...
namespace App\Libraries\Sanitizer;
...
class Sanitizer
{
     ...
     */
    protected $filters = [
        'capitalize'  => \App\Libraries\Sanitizer\Filters\Capitalize::class,
        'cast'        => \App\Libraries\Sanitizer\Filters\Cast::class,
        'escape'      => \App\Libraries\Sanitizer\Filters\EscapeHTML::class,
        'format_date' => \App\Libraries\Sanitizer\Filters\FormatDate::class,
        'lowercase'   => \App\Libraries\Sanitizer\Filters\Lowercase::class,
        'uppercase'   => \App\Libraries\Sanitizer\Filters\Uppercase::class,
        'trim'        => \App\Libraries\Sanitizer\Filters\Trim::class,
        'strip_tags'  => \App\Libraries\Sanitizer\Filters\StripTags::class,
        'digit'       => \App\Libraries\Sanitizer\Filters\Digit::class,
        'filter_if'   => \App\Libraries\Sanitizer\Filters\FilterIf::class,
        'persian_to_latin' => \App\Libraries\Sanitizer\Filters\PersianToLatin::class,
    ];
